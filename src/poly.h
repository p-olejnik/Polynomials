...
/**
 * Zwalnia z pamięci tablicę jednomianów.
 *
...
/**
 * Wykonuje operację złożenia wielomianów przez podstawienie w wielomianie
 * @f$p@f$ pod zmienną @f$x_i@f$ odpowiednio wielomianu @f$q_i@f$.
 * Jeśli liczba @f$k@f$ wielomianów @f$q_i@f$ w tablicy jest mniejsza
 * niż liczba @f$l@f$ zmiennych wielomianu @f$p@f$, wówczas pod zmienne
 * @f$x_k, \ldots, x_{l-1}@f$ podstawiane są zera.
 * @param[in] p : wielomian @f$p@f$
 * @param[in] k : liczba wielomianów
 * @param[in] q : tablica wielomianów @f$q_i@f$
